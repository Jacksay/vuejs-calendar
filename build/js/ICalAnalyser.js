...
_momentTimezone2.default.tz(_momentTimezone2.default.tz.guess());
...
var ICalAnalyser = function () {
    ...
    _createClass(ICalAnalyser, [{
        ...
        value: function generateItem(item) {
            // POST traitement
            var mmStart = (0, _momentTimezone2.default)(item.start);
            var mmEnd = (0, _momentTimezone2.default)(item.end);
            ...
            if (rrule.freq == 'DAILY' || rrule.freq == 'WEEKLY') {
                ...
                if (count) {
                    for (var i = 0; i < count; i++) {
                        ...
                        copy.start = (0, _momentTimezone2.default)(fromDate).toISOString();
                        copy.end = (0, _momentTimezone2.default)(toDate).toISOString();
                        copy.recursive = true;
                    ...
                    while (fromDate < end) {
                        ...
                        if (!(byday.indexOf(currentDay) < 0 || exdate.indexOf(fromDate.toISOString()) > -1)) {
                            ...
                            _copy.start = (0, _momentTimezone2.default)(fromDate).format();
                            _copy.end = (0, _momentTimezone2.default)(toDate).format();
        ...
        value: function parse(icsData) {
            ...
            // local TZ
            var defaultTimeZone = _momentTimezone2.default.tz.guess(),
                out = [],
                exceptions = [];
                ...
                if (d[0] == 'vevent') {
                    d[1].forEach(function (dd) {
                        if (dd[0] == 'uid') item.uid = dd[3];else if (dd[0] == 'rrule') {
                            ...
                            var m = _momentTimezone2.default.tz(dd[3], dd[1].tzid);
                            ...
                            item.lastModified = (0, _momentTimezone2.default)(dd[3]).format();
